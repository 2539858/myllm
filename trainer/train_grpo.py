...
from model.model_myllm import Config, ForCausalLM
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Myllm GRPO (Group Relative Policy Optimization)")
    ...
    parser.add_argument("--wandb_project", type=str, default="Myllm-GRPO", help="wandb项目名")
    ...
    lm_config = Config(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers,
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Myllm-GRPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
