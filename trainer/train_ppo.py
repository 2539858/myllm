...
# 自定义的Critic模型，继承自mylLM
class CriticModel(ForCausalLM):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Myllm PPO (Proximal Policy Optimization)")
    ...
    parser.add_argument("--wandb_project", type=str, default="Myllm-PPO", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Myllm-PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
