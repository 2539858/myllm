...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Myllm Full SFT")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMMiniMindind-Full-SFT", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Myllm-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
