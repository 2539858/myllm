...
from model.model_myllm import Config
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Myllm Knowledge Distillation")
    ...
    parser.add_argument("--wandb_project", type=str, default="Myllm-Distillation", help="wandb项目名")
    ...
    lm_config_student = Config(hidden_size=args.student_hidden_size, num_hidden_layers=args.student_num_layers, use_moe=bool(args.use_moe))
    lm_config_teacher = Config(hidden_size=args.teacher_hidden_size, num_hidden_layers=args.teacher_num_layers, use_moe=bool(args.use_moe))
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Myllm-Distill-S{args.student_hidden_size}T{args.teacher_hidden_size}-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
